...
<form >
  ...
  <tr>
      <td align="right"><button id="bt" class="add_bt" name="add"  type="button" onclick="IsEmpty()">اضافة جهة <img align="right" src="../../images/style images/add_icon.png" style="padding-left:5px" /></button></td>
