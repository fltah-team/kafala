...
<form action="saveuser.php" method="post">
 ...
 echo
  ...
  <tr>
      <td align="right" ><button name="add"  id="bt" class="add_bt" type="button" onclick="IsEmpty()">إضافة <img align="right" src="../../images/style images/add_icon.png" style="padding-left:5px" /></button></td>
