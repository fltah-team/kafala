...
<tr align="center" > 
    ...
    <?php
        $_SESSION['q'] =  "$extra";
    ?>
    <td><button name="add" class="info_bt" style="padding: 0 20px"  type="button" onclick="window.location.href = 'print_orphans.php?q=<?php echo $extra?>'"    > طباعة   <img align="right" src="../../images/style images/print_icon.png" style="padding-left:5px" /></button></td>
    <td></td>
  </tr>
  </table>
