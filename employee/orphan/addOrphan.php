...
<table width="85%" border="0" align="center">
  ...
  <tr>
    ...
    <td align="right"></td>
  	<td align="right">
    <label>
  	    <input name="gender" type="radio" id="male" value="1" checked="checked" />
  	    ذكر</label>
        <label>
...
<table width="85%" border="0" align="center" id=" ">
  <tr align="center">
  	...
  	<td width="41%" align="left"><input name="teachingr" type="text" disabled="disabled"  class="textFiels" id="teachingr" value="يدرس" size="30" maxlength="30" />
  	  السبب</td>
	<td width="14%" align="center"><label>
        <input type="radio" name="teaching" value="1" id="notlearn" onclick="checkLearn(1)" />
        لا يدرس</label></td>
        <td width="14%" align="center"><label>
        <input name="teaching" type="radio" id="learn" value="0" checked="checked" onclick="checkLearn(0)"/>
        يدرس</label></td>
        <td width="11%"></td>
  ...
  <tr align="center">
	...
	<td width="41%" align="left"><input class="textFiels" name="school" type="text" id="school" size="38" maxlength="30" /></td>
...
<br />
  ...
  <tr align="center">
	...
	<td width="14%" align="center">نوع المرض</td>
        ...
        <input type="radio" name="health" value="1" id="ill" onclick="checkIllness(1)" />
        سيئة</label></td>
        <td width="11%"><label>
        <input name="health" type="radio" id="notill" onclick="checkIllness(0)" value="0" checked="checked"/>
        جيدة</label></td>
    <script type="text/javascript" >
...
<table width="85%" border="0" align="center" id=" ">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td align="right"><input class="bt" name="add" onclick="ajax()" type="button"  value="اضافة يتيم" /></td>
    <td>&nbsp;</td>
  </tr>
</table>
</div>
